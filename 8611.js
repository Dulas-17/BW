...
container.innerHTML =   <img src="${s.image}" alt="${s.title}" />   <h2>${s.title}</h2>   <p>${s.description}</p>   <div class="episode-buttons">   ${s.episodes.map(ep => {   return<button onclick="playEpisode('${ep.link}', '${ep.title.replace(/'/g, "\'")}')">${ep.title}</button>;   }).join('')}   </div>   <div class="detail-bottom-actions">   <button onclick="shareContent('series', ${i})" class="btn share-btn">Share</button>   <button onclick="goBackToList('series')" class="back">Back</button>   <button onclick="copyLinkToClipboard('series', ${i})" class="btn copy-link-btn">Copy Link</button> </div>   ;
...
container.innerHTML =   <img src="${m.image}" alt="${m.title}" />   <h2>${m.title}</h2>   <p>${m.description}</p>   <div class="episode-buttons">   <button onclick="playEpisode('${m.link}', '${m.title.replace(/'/g, "\\'")}')">Watch Now</button>   </div>   <div class="detail-bottom-actions">    <button onclick="shareContent('movie', ${i})" class="btn share-btn">Share</button>   <button onclick="goBackToList('movies')" class="back">Back</button>   <button onclick="copyLinkToClipboard('movie', ${i})" class="btn copy-link-btn">Copy Link</button> </div>  ;
